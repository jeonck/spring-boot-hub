    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <nav className="mb-8">
        <div className="flex items-center space-x-2 text-sm text-gray-600">
          ...
          <span>/</span>
          <span className="text-gray-900 font-medium">자동 설정</span>
        </div>
      </nav>

      {/* Header */}
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-gray-900 mb-4">🔧 자동 설정 (Auto-Configuration)</h1>
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          Spring Boot의 가장 핵심적인 기능인 자동 설정의 동작 원리와 실제 구현 방법을 상세히 알아보세요.
        </p>
      </div>
